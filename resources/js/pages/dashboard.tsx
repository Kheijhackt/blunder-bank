        ...
        return (
            <AppLayout breadcrumbs={breadcrumbs}>
                ...
                <div className="flex h-full flex-1 flex-col gap-6 overflow-y-auto p-4 md:p-6">
                    ...
                    {/* Top Stats Grid Skeleton (4 Cards) */}
                    ...
                    {/* Main Action Area Skeleton */}
                    <div className="grid gap-6 lg:grid-cols-3">
                        {/* Left Column (Span 2) - Recommended Training */}
                        ...
                        {/* Right Column (Span 1) - Career Highlights */}
